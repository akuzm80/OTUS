...
[1. Создание сети и настройка основных параметров устройства;](README.md#Создание-сети-и-настройка-основных-параметров-устройства.)     
[2. Выбор корневого моста;](README.md#Выбор-корневого-моста.)  
[3. Наблюдение за процессом выбора протоколом STP порта, исходя из стоимости портов;](#стоимости)  
